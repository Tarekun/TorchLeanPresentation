...
\begin{frame}{Bottom line}
  \begin{columns}[c]
    \begin{column}{0.48\textwidth}
      \centering
      \includegraphics[width=\linewidth,height=0.60\textheight,keepaspectratio]{imgs/thumbsup.png}\\[0.4em]
      \Large\textbf{static typing: awesome (and TorchLean is pretty cool)}
    \end{column}
    \begin{column}{0.48\textwidth}
      \centering
      \includegraphics[width=\linewidth,height=0.60\textheight,keepaspectratio]{imgs/dread.png}\\[0.4em]
...
\begin{frame}{}
  \centering
  Want to find the rest of the code?\\[0.3em]
  \url{https://github.com/Tarekun/TorchLeanPresentation}

  \vfill
  \includegraphics[width=\linewidth,height=0.68\textheight,keepaspectratio]{imgs/repo.png}
\end{frame}
